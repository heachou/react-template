      ...
      <div className='login'>
        <div className='login-body'>
          <div className='login-top'>
            ...
            <div className='describle'>Ant Design 是西湖区最具影响力的 Web 设计规范</div>
          </div>
            ...
            <Form onSubmit={this.handleSubmit} className="login-form">
              <FormItem>
                {getFieldDecorator('userName', {
                  ...
                  <Input  placeholder="input placeholder" prefix={<Icon type="user" style={{ color: 'rgba(0,0,0,.25)' }} />} placeholder="Username" />
                )}
              </FormItem>
              <FormItem>
